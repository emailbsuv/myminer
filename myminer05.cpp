...
int randptr,mainroots[9][513],childroots[513][7][10],roots[256],tmp[256][513],rtmp[256][513],randcnt,randbytes[256],rootscnt,rootptr;
void initrandbytes(){
	int h=0;
	while(h==0){
...
void trap(){
	...
	for(int i=0;i<512;i++){
	  ...
	  char buffer [20];
  gcvt ((double)(100/(double)(512/plusone)),4,buffer);
	lstrcat(stm1,buffer);
